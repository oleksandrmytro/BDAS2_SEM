    ...
    public class BlobTableRepository : IBlobTableRepository
    {
        ...
        public async Task UpdateBlobContent(BLOB_TABLE content)
        {
            ...
            WHERE ID_BLOB = :IdBlob";
                ...
                parameters.Add("DatumModifikace", content.DatumModifikace, DbType.Date);
                parameters.Add("OperaceProvedl", content.OperaceProvedl, DbType.String);
                parameters.Add("PopisOperace", content.PopisOperace, DbType.String);
                parameters.Add("IdBlob", content.IdBlob, DbType.Int32);
